function t(e){switch(e){case"cloud":return`digraph {
    graph [TBbalance=min,
        bgcolor=transparent,
        compound=true,
        fontname=Arial,
...
`;default:throw new Error("Unknown viewId: "+e)}}function n(e){switch(e){case"cloud":return`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
